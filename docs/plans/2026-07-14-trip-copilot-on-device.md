...
**Chat-primary UI + offline voice + agent APIs:** [`2026-07-20-command-surface-voice-pipeline.md`](./2026-07-20-command-surface-voice-pipeline.md) — Chat is primary human I/O; plan chrome + option cards are artifacts; Whisper offline; MCP/CLI/API for other agents.  
**Conversation + multi-party (depth):** [`2026-07-20-conversational-collaborative-planning.md`](./2026-07-20-conversational-collaborative-planning.md) — sessions, moves, stances, facilitation.
