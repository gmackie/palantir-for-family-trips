...
## Latest planner ship (2026-07-12)

Channels `production`, `preview`, and `development` all received:

`feat: day plan, amenities, iOverlander overnight, OTA check`

| Channel | iOS runtime | Android runtime |
| --- | --- | --- |
| production / preview | `ec0c045b…` | `cdbe993b…` |
