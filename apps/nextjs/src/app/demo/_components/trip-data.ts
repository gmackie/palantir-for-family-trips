...
export const TRIP_META = {
  ...
  airbnb: {
    ...
    gateNote:
      "Community access details are intentionally withheld in the sanitized demo.",
    parkingNote:
      "Parking guidance is intentionally simplified in the sanitized demo.",
    directionsNote:
...
export const INITIAL_FAMILIES = [
  ...
  },
  {
    ...
    readiness: 88,
    routeSummary:
      "Short Bay Area drive with a quick Oakdale reset before Pine Mountain Lake",
    checklist: [
  ...
  },
  {
    ...
    checklist: [
      ...
      {
        id: "yosemite-daypack",
        label: "Yosemite daypacks staged",
        done: false,
      },
...
export const ACTIVITIES = [
  {
    ...
    backup:
      "If traffic spikes, switch to late arrival meal and minimum-viable setup.",
  },
  {
    id: "fri-lake",
    ...
    backup:
      "If weather or parking gets weird, shift to cabin hang + shorter local outing.",
  },
  {
    id: "sat-yosemite",
    title: "Yosemite Day",
    ...
    backup:
      "If showers worsen, downgrade to scenic stops + flexible walking plan.",
  },
  {
    id: "sun-home",
    title: "Sunday Return",
    ...
    window: "Sun / checkout",
    description:
      "Pack, cabin reset, check-out, and staggered drive home windows.",
