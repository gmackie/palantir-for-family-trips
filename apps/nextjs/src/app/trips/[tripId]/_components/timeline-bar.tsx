  ...
  return (
    <div className="border-t border-[#21262D] bg-[#0D1117]">
      ...
      >
        ...
        {days.length > 0 && (
          <span className="text-[9px] text-[#484F58]">{days.length} days</span>
        )}
      </button>
        ...
        <div className="overflow-x-auto px-4 pb-3">
          {days.length === 0 ? (
            ...
            <div
              ...
              style={{ minWidth: `${days.length * 120}px` }}
            >
              {days.map((day) => {
                ...
                return (
                  ...
                  >
                    <p
                      className={`text-[9px] font-bold ${isToday ? "text-[#58A6FF]" : "text-[#8B949E]"}`}
                    >
                      {dayLabel}
                    </p>
